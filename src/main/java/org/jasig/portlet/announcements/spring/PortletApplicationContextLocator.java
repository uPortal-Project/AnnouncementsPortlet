...
/**
 * Provides standard access to the portal's {@link org.springframework.context.ApplicationContext}.
...
public class PortletApplicationContextLocator implements ServletContextListener {
  ...
  private static final SingletonDoubleCheckedCreator<ConfigurableApplicationContext>
      applicationContextCreator = new PortletApplicationContextCreator();
  ...
  /**
   * If running in a web application the existing {@link
   * org.springframework.web.context.WebApplicationContext} will be returned. if not a singleton
   * {@link org.springframework.context.ApplicationContext} is created if needed and returned.
   * Unless a {@link org.springframework.web.context.WebApplicationContext} is specifically needed
